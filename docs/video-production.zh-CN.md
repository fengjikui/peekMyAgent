...
当前第一份完整技术候选来自提交 `ec33fd6282af42ab146b787a4bd31d791e483edb`：快速上手 251 秒、7530 帧、约 4.72 MiB。成片按全部 28 个 `review_points` 抽帧后，与已验收桌面帧的平均绝对像素差为 2.27/255；画幅、黑边、控制器、字幕层和渐进编号均通过检查。它仍是等待所有者审阅中文故事的无声画面母版，不等于已经发布的视频。
