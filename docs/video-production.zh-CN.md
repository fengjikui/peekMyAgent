...
当前已有两份完整技术候选。快速上手来自提交 `ec33fd6282af42ab146b787a4bd31d791e483edb`：251 秒、7530 帧、约 4.72 MiB；成片按全部 28 个 `review_points` 抽帧后，与已验收桌面帧的平均绝对像素差为 2.27/255。Claude Code 工具闭环来自提交 `4bb27179a4e893cc986e7016a87515a0a0066314`：245 秒、7350 帧、约 4.55 MiB；36 点比较的平均绝对像素差为 1.47/255，最大 3.96/255 出现在正常 Raw 交叉淡化帧。两者的画幅、黑边、控制器、字幕层、完整解码和渐进编号均通过检查；它们仍是等待所有者审阅中文故事的无声画面母版，不等于已经发布的视频。
