...
const turnStoryModelSource = fs.readFileSync(new URL("../src/viewer/turn-story-model.js", import.meta.url), "utf8");
const turnStoryRendererSource = fs.readFileSync(new URL("../src/viewer/turn-story-renderer.js", import.meta.url), "utf8");
...
assert.doesNotMatch(turnStoryModelSource, /\bdocument\b|\bwindow\b|\bfetch\s*\(|\bstate\./);
